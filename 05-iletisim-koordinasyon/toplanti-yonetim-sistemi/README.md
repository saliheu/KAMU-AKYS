...
Bu modül **iletisim koordinasyon** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **toplanti yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan toplanti yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
