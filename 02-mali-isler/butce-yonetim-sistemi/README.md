# uutce yonetim sistemi

Bu modül **mali isler** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **uutce yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan uutce yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
