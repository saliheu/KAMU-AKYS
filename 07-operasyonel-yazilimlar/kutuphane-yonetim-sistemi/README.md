...
Bu modül **operasyonel yazilimlar** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **kutuphane yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan kutuphane yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
