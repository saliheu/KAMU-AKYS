# dilekce sikayet yonetim sistemi

Bu modül **vatandas hizmetleri** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **dilekce sikayet yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan dilekce sikayet yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
