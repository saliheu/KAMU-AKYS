# elektronik uelge yonetim sistemi

Bu modül **uelge yonetim** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **elektronik uelge yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan elektronik uelge yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
