...
Bu modül **insan kaynaklari** kategorisi altında kamu kurumları için geliştirilecek açık kaynak **izin yonetim sistemi** projesidir.

## Proje Hakkında

Bu proje, kamu kurumlarının dijital dönüşüm sürecinde ihtiyaç duyulan izin yonetim sistemi çözümünü açık kaynak olarak sunmayı hedeflemektedir.
